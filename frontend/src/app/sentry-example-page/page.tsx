    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://saas-barbearia.sentry.io/issues/?project=4510439862763520">Issues Page</a>.
